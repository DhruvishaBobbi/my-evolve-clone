...
const ProgramsSection = () => {
  return <section id="programs" className="py-20 bg-muted/30">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <p className="text-primary font-bold text-sm tracking-wider uppercase mb-4">
            What We Offer
          </p>
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-black text-secondary mb-4">Fitness by women for women</h2>
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto">Women don't run on a 24hr hormonal cycle, so why should they exercise on one?</p>
        </div>

        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {programs.map((program, index) => <Card key={index} className="border-2 hover:border-primary transition-all hover:shadow-lg">
