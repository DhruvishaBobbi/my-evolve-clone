  ...
  return <div className="min-h-screen">
      ...
      <section className="relative min-h-[60vh] flex items-center justify-center overflow-hidden bg-gradient-to-br from-primary/5 via-background to-secondary/5">
        <div className="absolute inset-0 opacity-20">
          <img src={heroImage} alt="Bobbi App Interface" className="w-full h-full object-cover" />
        </div>
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl mx-auto py-20">
          ...
          <p className="text-xl md:text-2xl text-muted-foreground mb-8">Personalised workouts designed for your cycle and your goals</p>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          ...
          {steps.map((step, index) => <div key={index} className={`grid md:grid-cols-2 gap-12 items-center ${index % 2 === 1 ? 'md:flex-row-reverse' : ''}`}>
              ...
              <div className={`space-y-6 ${index % 2 === 1 ? 'md:order-2' : ''}`}>
                ...
                <ul className="space-y-3">
                  {step.highlights.map((highlight, idx) => <li key={idx} className="flex items-start gap-3">
                      <CheckCircle2 className="h-6 w-6 text-primary flex-shrink-0 mt-0.5" />
                      <span className="text-muted-foreground">{highlight}</span>
                    </li>)}
                </ul>

                {index === steps.length - 1 && <Button size="lg" className="mt-4 gap-2">
                    Get Started Now
                    <ArrowRight className="h-5 w-5" />
                  </Button>}
              </div>
              ...
              <div className={`relative ${index % 2 === 1 ? 'md:order-1' : ''}`}>
                ...
                {index < steps.length - 1 && <div className="hidden md:block absolute -bottom-24 left-1/2 transform -translate-x-1/2">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="text-center hover:shadow-lg transition-shadow">
              <CardContent className="p-8">
                ...
                <h3 className="text-xl font-bold mb-3">Cycle-Informed Training</h3>
                <p className="text-muted-foreground">Across the different phases of your cycle your body reacts to exercise differently. In some phases you have less energy and are more prone to injury. In others you are at your strongest. Women don’t have a 24hr hormone cycle, so we shouldn’t workout like we do. </p>
              </CardContent>
            </Card>
            ...
            <Card className="text-center hover:shadow-lg transition-shadow">
              <CardContent className="p-8">
                ...
                <h3 className="text-xl font-bold mb-3">Less likely to hurt yourself</h3>
                <p className="text-muted-foreground">Exercising in line with the 28 day cycle allows you to workout in line with your body. You will be less likely to injure yourself as you are working with your body’s hormones not against them.</p>
              </CardContent>
            </Card>
            ...
            <Card className="text-center hover:shadow-lg transition-shadow">
              <CardContent className="p-8">
                ...
                <h3 className="text-xl font-bold mb-3">See progression across your cycle </h3>
                <p className="text-muted-foreground">Bobbi will show you your progress in line with the 28 day and four phase cycle, meaning you can see informed progress from your workouts, rather than being disheartened and demotivated every month.</p>
              </CardContent>
            </Card>
          </div>
        </section>
        ...
        <section className="text-center py-20 px-4 bg-gradient-to-r from-primary/10 via-secondary/10 to-primary/10 rounded-3xl">
          ...
          <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">Start your first cycle-informed workout today — download Bobbi now and join the other women training in sync with their bodies.</p>
